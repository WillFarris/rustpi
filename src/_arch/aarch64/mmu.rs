...
const TRANSLATION_DESCRIPTIONS: [TranslationDescription; 2] = [
    TranslationDescription {start: PBASE_START, end_inclusive: PBASE_END},
    TranslationDescription {start: unsafe {&LOCKS_START as *const u8 as usize}, end_inclusive: unsafe { &LOCKS_END as *const u8 as usize} },
];*/
